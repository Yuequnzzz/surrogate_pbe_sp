...
def main(X, Y, type, hidden_size, no_layers, num_epochs, batch_size, lr):
    # choose the type
    choose_type = type
...
if __name__ == '__main__':
    ...
    for key, value in output_dict.items():
        ...
        y_est, y_test = main(X, value, choose_type, hidden_size=50, no_layers=8, num_epochs=100, batch_size=32, lr=0.001)
        # save the results
