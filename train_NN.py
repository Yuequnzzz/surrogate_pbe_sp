...
if __name__ == "__main__":
    ...
    save_name = "InputMat_231103_0949"
    input_mat, results = load_data(save_name)

    X, Y = reformat_input_output(input_mat, results)

    # # Load data
    # input_file_name = "C:/Users/yueqzhang/PycharmProjects/GMM/data/sparse_training_data/InputMat_231021_0805_input_41_35.csv"
    # output_file_name = "C:/Users/yueqzhang/PycharmProjects/GMM/data/sparse_training_data/InputMat_231021_0805_output_41_35.csv"
    # X = pd.read_csv(input_file_name)
    # Y = pd.read_csv(output_file_name)
    # X = X.to_numpy()
    # Y = Y.to_numpy()
